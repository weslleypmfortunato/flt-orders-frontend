        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col mb-1 w-3/5 border rounded mt-4">
              ...
              <div className="flex flex-col mb-1 text-left p-2">
                <label className="text-lg font-semibold">Cause of NCR:</label>
                <textarea
                  className="border rounded p-1"
                  value={causeOfNcr}
                  onChange={e => setCauseOfNcr(e.target.value)}
                  placeholder="Go to the NCR edit page to fill in this information."
                  disabled
                />

                <label className="text-lg font-semibold mt-2">Close-out Date:</label>
                <DatePicker
                  className="px-1 w-48 border rounded"
                  selected={closeOutDate}
                  onChange={(date) => setCloseOutDate(date)}
                  dateFormat="yyyy-MM-dd"
                  placeholderText="Go to the NCR edit page."
                  disabled
                />

                <label className="text-lg font-semibold mt-2">Reason for Closure:</label>
                <textarea
                  className="border rounded p-1"
                ...
                <label className="text-lg font-semibold mt-2">Latest Disposition:</label>
                <input
                  type="text"
                  className="border rounded p-1"
                ...
                <label className="text-lg font-semibold mt-2">Closer:</label>
                <input
                  type="text"
                  className="border rounded p-1"
                  value={closer}
